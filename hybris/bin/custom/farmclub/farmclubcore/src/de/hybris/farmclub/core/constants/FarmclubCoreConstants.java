 ...
 */
package de.hybris.farmclub.core.constants;

/**
 * Global class for all FarmclubCore constants. You can add global constants for your extension into this class.
 */
public final class FarmclubCoreConstants extends GeneratedFarmclubCoreConstants
{
	public static final String EXTENSIONNAME = "farmclubcore";


	private FarmclubCoreConstants()
	{
		//empty
	}
