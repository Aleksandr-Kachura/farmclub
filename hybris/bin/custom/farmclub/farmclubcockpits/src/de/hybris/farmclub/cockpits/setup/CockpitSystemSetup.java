 ...
 */
package de.hybris.farmclub.cockpits.setup;
...
import de.hybris.farmclub.cockpits.constants.FarmclubCockpitsConstants;
 ...
 */
@SystemSetup(extension = FarmclubCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(FarmclubCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(FarmclubCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						FarmclubCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/farmclubcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
