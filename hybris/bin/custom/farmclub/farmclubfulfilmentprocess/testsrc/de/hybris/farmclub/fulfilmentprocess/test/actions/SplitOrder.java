 ...
 */
package de.hybris.farmclub.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(FarmclubFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(FarmclubFulfilmentProcessConstants.PARENT_PROCESS);
