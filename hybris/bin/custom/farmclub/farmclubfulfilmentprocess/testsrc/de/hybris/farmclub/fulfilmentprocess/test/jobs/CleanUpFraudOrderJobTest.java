 ...
 */
package de.hybris.farmclub.fulfilmentprocess.test.jobs;
...
import de.hybris.farmclub.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = FarmclubFulfilmentProcessConstants.ORDER_PROCESS_NAME;
