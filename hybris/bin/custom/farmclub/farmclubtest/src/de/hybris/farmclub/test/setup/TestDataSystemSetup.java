 ...
 */
package de.hybris.farmclub.test.setup;
...
import de.hybris.farmclub.test.constants.FarmclubTestConstants;
import de.hybris.farmclub.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = FarmclubTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/farmclubtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/farmclubtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/farmclubtest/import/cstickets.impex");
			...
			importImpexFile(context, "/farmclubtest/import/csquotes.impex");
		}
	}
}
