...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/farmclubstorefront/electronics/en",
						"https://electronics.local:9002/farmclubstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/farmclubstorefront/electronics/en",
						"https://electronics.local:9002/farmclubstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/farmclubstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/farmclubstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/farmclubstorefront/electronics/en",
						"https://electronics.local:9002/farmclubstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/farmclubstorefront",
						"https://electronics.local:9002/farmclubstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/farmclubstorefront",
						"https://electronics.local:9002/farmclubstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/farmclubstorefront/electronics/en",
						"https://electronics.local:9002/farmclubstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
