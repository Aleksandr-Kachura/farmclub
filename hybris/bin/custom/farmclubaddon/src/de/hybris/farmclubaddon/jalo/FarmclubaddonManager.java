 ...
 */
package de.hybris.farmclubaddon.jalo;
...
import de.hybris.farmclubaddon.constants.FarmclubaddonConstants;



/**
 * This is the extension manager of the Farmclubaddon extension.
 */
public class FarmclubaddonManager extends GeneratedFarmclubaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(FarmclubaddonManager.class.getName());
	 ...
	 */
	public static FarmclubaddonManager getInstance()
	{
		return (FarmclubaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				FarmclubaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public FarmclubaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of FarmclubaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of FarmclubaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of FarmclubaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
